...
// MARK: - PacketAnalyzerDelegate Protocol

/// Protocol for PacketAnalyzer to communicate with its owner
/// Allows PacketAnalyzer to work with either AppDelegate or managers
protocol PacketAnalyzerDelegate: AnyObject {
    var gameState: GameState { get }
    var serverFeatures: [String] { get set }
